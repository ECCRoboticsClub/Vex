...
#pragma config(Motor,  port5,           leftRearMotor, tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port6,           rightRearMotor, tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port7,           elevatorMotor, tmotorVex393HighSpeed_MC29, openLoop)
