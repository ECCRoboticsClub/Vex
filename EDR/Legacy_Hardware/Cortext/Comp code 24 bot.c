...
task usercontrol()
{
	...
	while (true)
	{
		...
		{
			motor[fl]  = (vexRT[Ch3])/2;   // Left Joystick Y value / 2.
		}
		...
		{
			motor[fr] = (vexRT[Ch2])/2;   // Right Joystick Y value / 2.
		}
		...
		{
			motor[am1] = (vexRT [Ch3Xmtr2])/2;   // Right Joystick Y value / 2.
		}
		else                                    // If the right joystick is within the threshold:
		{
		...
		{
			motor[barlift] = (vexRT [Ch2Xmtr2])/2;   // Right Joystick Y value / 2.
		}
		else                                    // If the right joystick is within the threshold:
		{
