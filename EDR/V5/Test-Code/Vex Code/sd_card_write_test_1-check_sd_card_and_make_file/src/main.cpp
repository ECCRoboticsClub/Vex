...
int main() {
    if( Brain.SDcard.isInserted() ) {
      ...
      ofs << ofs << "time (msec),battery,,controller1,,,,,,,,,,,,,,,,,,,,motor1,,,,,,,,,,,,motor2,,,,,,,,,,,,\r\n";
      ofs << "senors,capacity,temperature,Axis1 (position),Axis1 (value),Axis2 (position),Axis2 (value),Axis3 (position),Axis3 (value),Axis4 (position),Axis4 (value),ButtonA,ButtonB,ButtonX,ButtonY,ButtonUp,ButtonDown,ButtonLeft,ButtonRight,ButtonL1,ButtonL2,ButtonR1,ButtonR2,efficiency (percent),velocity (rpm),velocity (degrees per second),velocity (percent),rotation (degrees),rotation (rev),rotation (raw),torque (Nm),torque (InLb),current (amp),power (watt),temperature (fahrenheit),temperature (percent),efficiency (percent),velocity (rpm),velocity (degrees per second),velocity (percent),rotation (degrees),rotation (rev),rotation (raw),torque (Nm),torque (InLb),current (amp),power (watt),temperature (fahrenheit),temperature (percent)\r\n";
	for (int i=0; i<30000; i++) {
	ofs << Brain.timer(vex::timeUnits::msec)
            << ","<< Brain.Battery.capacity(vex::percentUnits::pct) << ","<< Brain.Battery.temperature(vex::temperatureUnits::fahrenheit)
