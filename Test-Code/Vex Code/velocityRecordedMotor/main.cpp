...
/*    Created:      Tue Jun 04 2019                                           */
/*    Description:  Example of recording and playback of user controlled      */
/*                  routine. Saves and loads from SD card.                    */
/*                                                                            */
/*----------------------------------------------------------------------------*/
#include "vex.h"
#include <list>
...
int main(void) {
    ...
    while (true) {
        ...
        YlastPressed = YlastPressed && con.ButtonY.pressing();
         ...
         recordedMotor1.spin(vex::directionType::fwd,con.Axis3.position(vex::percentUnits::pct),vex::velocityUnits::pct);
        recordedMotor10.spin(vex::directionType::fwd,con.Axis2.position(vex::percentUnits::pct),vex::velocityUnits::pct);
